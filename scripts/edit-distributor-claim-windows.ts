...
const CLAIM_START_TS = new anchor.BN(1718961368); // June 2 00:00
const FULL_CLAIM_FROM = new anchor.BN(1719223200); // June 9 00:00
const CLAIM_END_TS = new anchor.BN(1738409600); // June 15 00:00
